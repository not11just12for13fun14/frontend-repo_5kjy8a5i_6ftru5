    ...
    <section id="onboarding" className="relative py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center max-w-2xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-white">Delightful onboarding</h2>
            ...
            <div className="mt-6 relative h-56 sm:h-64">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="absolute inset-0 rounded-2xl bg-[#141833] border border-white/10"
                >
                  <div className="p-6">
